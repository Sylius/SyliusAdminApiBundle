...
EOT;
     ...
     * @test
     */
    public function it_does_not_allow_nulling_information_about_product_variant_options(): void
    {
        $this->loadFixturesFromFile('authentication/api_administrator.yml');
        $productVariantsData = $this->loadFixturesFromFiles([
            'resources/locales.yml',
...
EOT;
     ...
     * @test
     */
    public function it_does_not_allow_nulling_information_about_product_variant_options_in_product_without_options(): void
    {
        $this->loadFixturesFromFile('authentication/api_administrator.yml');
        $productVariantsData = $this->loadFixturesFromFiles([
            'resources/locales.yml',

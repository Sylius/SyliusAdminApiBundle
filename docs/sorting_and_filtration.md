...
[here](https://github.com/Sylius/Sylius/tree/master/src/Sylius/Bundle/AdminApiBundle/Resources/config/grids).
...
You can find a list of all search options in [GridBundle docs](https://github.com/Sylius/SyliusGridBundle/blob/master/docs/index.md).

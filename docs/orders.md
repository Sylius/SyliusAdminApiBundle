...
Your value can be different. If you need more information about Cart API please, check [this article](https://docs.sylius.com/en/latest/api/admin_api/carts.html).

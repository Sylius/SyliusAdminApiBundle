...
Read more about [Taxons](https://docs.sylius.com/en/latest/components_and_bundles/components/Taxonomy/models.html).
...
[here](https://github.com/Sylius/Sylius/blob/master/tests/Controller/TaxonApiTest.php).
